...
Portfólio de projetos de engenharia de dados — do básico ao avançado.
Cada projeto resolve um problema real com dados públicos, documentado com arquitetura, decisões técnicas e instruções de reprodução.
...
Cada projeto é autocontido — entre na pasta, leia o `README.md` e siga as instruções para rodar localmente.
